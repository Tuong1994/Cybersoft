...
function RwdProgress(props) {
    const [studentVideo, setStudentVideo] = useState(false);
    const linkStudent = "../videos/review-2.mp4"
    return (
        <div className="content__rwd-progress">
            <div className="rwd-progress__img">
            ...
            <div className="rwd-progress__content">
